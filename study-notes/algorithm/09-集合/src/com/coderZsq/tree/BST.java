...
public class BST<E> extends BinaryTree {
    ...
    public void add(E elemment) {
        ...
        while (node != null) {
            ...
            if (cmp > 0) {
                ...
                node.element = elemment;
                return;
            }
        }

        // 看看插入到父节点的哪个位置
        Node<E> newNode = createNode(elemment, parent);
        if (cmp > 0) {
    ...
    /**
     * 删除node之后的调整
     * @param node 被删除的节点 或者 用以取代被删除的子节点 (当被删除节点的度为1)
     * */
