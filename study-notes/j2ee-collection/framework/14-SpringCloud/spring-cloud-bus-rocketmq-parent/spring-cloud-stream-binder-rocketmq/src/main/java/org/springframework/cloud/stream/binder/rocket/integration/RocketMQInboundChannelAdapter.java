...
package org.springframework.cloud.stream.binder.rocket.integration;
...
public class RocketMQInboundChannelAdapter extends MessageProducerSupport {
    ...
    private final ExtendedConsumerProperties<RocketConsumerProperties> consumerProperties;
    private RetryTemplate retryTemplate;
    private RecoveryCallback<? extends Object> recoveryCallback;
    private RocketListenerBindingContainer rocketMQListenerContainer;


    public RocketMQInboundChannelAdapter(
            RocketListenerBindingContainer rocketMQListenerContainer,
