...
public class UploadUtil {
	//阿里域名
	public static final String ALI_DOMAIN = "https://wolf2w-49.oss-cn-guangzhou.aliyuncs.com/";
	...
	public static String uploadAli(MultipartFile file) throws Exception {
		...
		String accessKeyId = "LTAI4GAhqf7EtTJTvg8TpM2m";
		String accessKeySecret = "y6iaNrRkN1zaZzic8uiLRgcV6PUKfd";

		// 创建OSSClient实例。
		OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId,accessKeySecret);
		// 上传文件流。
		ossClient.putObject("wolf2w-49", fileName, file.getInputStream());
		// 关闭OSSClient。
		ossClient.shutdown();
