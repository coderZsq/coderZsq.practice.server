            ...
            <div class="box">
                ...
                <div style="margin: 10px;">
                    ...
                    <form class="form-inline" id="searchForm" action="/role/list.do" method="post">
                        ...
                        <a href="javascript:;" data-url="/role/input.do" class="btn btn-success btn-redirect">
                    ...
                    <table class="table table-striped table-hover" >
                       ...
                       <#list pageInfo.list as entity>
                           <tr>
                               ...
                               <td>${entity.sn}</td>
                               <td>
                                   <a class="btn btn-info btn-xs btn-redirect" href="javascript:;" data-url="/role/input.do?id=${entity.id}">
