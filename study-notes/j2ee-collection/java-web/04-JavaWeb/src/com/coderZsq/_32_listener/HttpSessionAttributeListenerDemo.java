...
public class HttpSessionAttributeListenerDemo implements HttpSessionAttributeListener {
    ...
    public void attributeReplaced(HttpSessionBindingEvent httpSessionBindingEvent) {
        System.out.println("属性替换 " + httpSessionBindingEvent.getName() +  ", " + httpSessionBindingEvent.getValue() +  ", " + httpSessionBindingEvent.getSession().getAttribute(httpSessionBindingEvent.getName()));
    }
}
