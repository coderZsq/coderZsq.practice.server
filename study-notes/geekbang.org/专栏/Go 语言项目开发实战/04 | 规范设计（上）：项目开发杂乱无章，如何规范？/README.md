...
更具体的示例，你可以参考 IAM 系统的 README.md 文件 。
...
如果掌握了这些内容之后，你还想了解更详细的 API 接口文档规范，可以参考这个 链接 。
...
今天示范用到的项目规范示例，我把详细版放在这里，方便你随时查看：开源规范 、 README 规范 、 API 接口文档规范 。

### 课后练习

1. 除了今天我们介绍的这些非编码类规范之外，你在开发中还用到过哪些规范?
2. 试着用这一讲介绍的 API 文档规范，书写一份你当前项目的 API 接口。
