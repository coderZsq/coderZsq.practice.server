...
![IAM 系统的功能示意图](https://static001.geekbang.org/resource/image/ee/50/eed75fcd91d6e726ca74315d65193150.jpg?wh=2513*1134)
...
![前 5 个组件是我们需要实现的核心组件。后 4 个组件是一些旁路组件，不影响项目的使用。如果感兴趣，你可以自行实现](https://static001.geekbang.org/resource/image/6c/71/6cdbde36255c7fb2d4f2e718c9077a71.jpeg?wh=1920*1043)
