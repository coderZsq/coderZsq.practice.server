...
public class HandleResponseController {
	...
	public void test2(OutputStream out) throws IOException {
		Files.copy(Paths.get("C:/abc.rar"), out);
	}
	...
	public ModelAndView test3() {
		...
		mv.addObject("叩丁狼教育");//设置共享数据value,此时会把value类型的首字母作为key:string
	...
	/*
	 	...
	 	请求资源的路径问题: 以后访问资源的时候,都使用/开头.
	 		重定向 redirect:/hello.html 和 redirect:hello.html
	 			...
	 			/response/test6----->"redirect: shello.html";--->localhost:/response/hello.html
